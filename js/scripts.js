...
libros[6] = ["img/libro7.jpg", "Cinco días de Octubre", 15.90.toFixed(2)];
libros[7] = ["img/libro8.jpg", "Ocho dias de Marzo", 15.90.toFixed(2)];
libros[8] = ["img/libro9.jpg", "El extranjero", 15.90.toFixed(2)];
...
function cantidad(libroComprado,incremento){ // Con esta función añadimos la capacidad de almacenar cantidades, a través de unos buttons situados dentro de la línea del propio libro en el carrito.
...
function refrescaTabla(){ // Función para imprimir el carrito, recorre el array con el (for) y imprime el libro comprado a través del indice, de esta forma sabe que si clickamos en comprar el tercer libro, deberá recorrer el array hasta el número 2, y una vez ahí imprimir el string [1] que en este caso es el nombre, y después imprimir el [2], que se trata del precio, creando así la linea en el carrito.
 ...
 +" <span onclick='cantidad("+i+",+1)' class='glyphicon glyphicon-plus-sign'></span></td> <td> <button type='button' onclick='eliminarLibro("+i+")' >Retirar</span></td> </tr>";
  }
  document.getElementById("productos-carrito").innerHTML=salida;
}
